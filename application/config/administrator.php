...
return array(
	...
	'menu' => array(
		'books',
		'contents',
		'Личности' => array('authors', 'translators', 'compilers', 'illustrators'),
		'Издатели' => array('publishers', 'printhouses'),
		'Допълнителни' => array('sequences', 'themes', 'languages'),
	),
